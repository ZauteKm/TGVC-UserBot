...
DELETE_DELAY = 120
DURATION_AUTOPLAY_MIN = 36000
DURATION_PLAY_HOUR = 120
...
- Repository: [GitHub](https://github.com/ZauteKm/TGVC-UserBot)
...
async def play_track(client, m: Message):
    ...
    # check audio
    if m.audio:
        if m.audio.duration > (DURATION_AUTOPLAY_MIN * 36000):
        ...
        if m_audio.audio.duration > (DURATION_PLAY_HOUR * 432000 * 7200):
            reply = await m.reply_text(
                f"{emoji.ROBOT} audio which duration longer than "
